...
class Info {
    ...
    readyMsg(gridSize) {
        var html = (
            `<table>
                <tr class="small_table" >           <td>Tick size</td>  <td>${gridSize} mm</td> </tr>
                <tr class="small_table info_red">   <td>X-Axis</td>     <td>Red</td>    </tr>
                <tr class="small_table info_green"> <td>Y-Axis</td>     <td>Green</td>  </tr>
                <tr class="small_table info_blue">  <td>Z-Axis</td>     <td>Blue</td>   </tr>
            </table>`
        )
        this.addHtml(html)
    }
    ...
    bbInfo(path, name, bb) {
        var html = (
            `<table>
                <tr class="small_table"><td><b>Path</b></td><td>${path}</td></tr>
                <tr class="small_table"><td><b>Name</b></td><td>${name}</td></tr>
            </table>
            <table>
            `
        )
