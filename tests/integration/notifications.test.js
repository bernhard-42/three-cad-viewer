...
describe("Render Initial Notification", () => {
  ...
  test("render sends initial notification with required keys", async () => {
    ...
    const initialNotification = collector.notifications.find(
      (n) => "tab" in n && "target" in n && "clip_normal_0" in n,
    );
...
describe("Setter Notifications via State", () => {
  ...
  test("setAxes sends axes notification", async () => {
    ...
    const notification = getLastNotificationWithKey(
...
describe("Clipping Notifications", () => {
  ...
  test("setClipSlider for each index sends correct key", async () => {
    ...
    expect(
      getLastNotificationWithKey(collector.notifications, "clip_slider_0"),
    ).toBeDefined();
    ...
    expect(
      getLastNotificationWithKey(collector.notifications, "clip_slider_1"),
    ).toBeDefined();
    ...
    expect(
      getLastNotificationWithKey(collector.notifications, "clip_slider_2"),
    ).toBeDefined();
  });
...
describe("Grid Notifications", () => {
  ...
  test("setGridCenter with notify=false does not send notification", async () => {
    ...
    expect(
      getLastNotificationWithKey(collector.notifications, "center_grid"),
    ).toBeNull();
  });
});
...
describe("No Duplicate Notifications", () => {
  ...
  test("old value is tracked correctly", async () => {
    ...
    // First change
    viewer.setAxes(false);
    const notification1 = getLastNotificationWithKey(
      collector.notifications,
      "axes",
    );
    ...
    // Second change
    viewer.setAxes(true);
    const notification2 = getLastNotificationWithKey(
      collector.notifications,
      "axes",
    );
...
describe("STATE_TO_NOTIFICATION_KEY Mapping", () => {
  ...
  test("all mapped state keys produce correct notification keys", async () => {
    ...
    const testCases = [
      ...
      {
        setter: () => viewer.setTransparent(true),
        notificationKey: "transparent",
      },
      {
        setter: () => viewer.setBlackEdges(true),
        notificationKey: "black_edges",
      },
      { setter: () => viewer.setGlass(true), notificationKey: "glass" },
      {
        setter: () => viewer.setAmbientLight(0.5),
        notificationKey: "ambient_intensity",
      },
      {
        setter: () => viewer.setDirectLight(0.5),
        notificationKey: "direct_intensity",
      },
      { setter: () => viewer.setMetalness(0.5), notificationKey: "metalness" },
      { setter: () => viewer.setRoughness(0.5), notificationKey: "roughness" },
      {
        setter: () => viewer.setOpacity(0.5),
        notificationKey: "default_opacity",
      },
      {
        setter: () => viewer.setClipIntersection(true),
        notificationKey: "clip_intersection",
      },
      {
        setter: () => viewer.setClipObjectColorCaps(true),
        notificationKey: "clip_object_colors",
      },
      {
        setter: () => viewer.setClipPlaneHelpers(true),
        notificationKey: "clip_planes",
      },
    ];
...
describe("Control Speed Notifications", () => {
  ...
  test("control speeds with notify=false do not send notifications", async () => {
    ...
    expect(
      getLastNotificationWithKey(collector.notifications, "zoom_speed"),
    ).toBeNull();
    expect(
      getLastNotificationWithKey(collector.notifications, "pan_speed"),
    ).toBeNull();
    expect(
      getLastNotificationWithKey(collector.notifications, "rotate_speed"),
    ).toBeNull();
  });
});
...
describe("Collapse State Notifications", () => {
  ...
  test("collapseNodes with notify=false does not send notification", async () => {
    ...
    expect(
      getLastNotificationWithKey(collector.notifications, "collapse"),
    ).toBeNull();
  });
});
...
describe("Explode Notifications", () => {
  ...
  test("setExplode with notify=false does not send notification", async () => {
    ...
    expect(
      getLastNotificationWithKey(collector.notifications, "explode"),
    ).toBeNull();
  });
...
describe("Tab Switching Notifications", () => {
  ...
  test("setActiveTab with notify=false does not send notification", async () => {
    ...
    expect(
      getLastNotificationWithKey(collector.notifications, "tab"),
    ).toBeNull();
  });
...
describe("Glass Mode Notifications", () => {
  ...
  test("glassMode with notify=false does not send notification", async () => {
    ...
    expect(
      getLastNotificationWithKey(collector.notifications, "glass"),
    ).toBeNull();
  });
});
...
describe("Measurement Tool Workflow", () => {
  ...
  test("handleBackendResponse processes properties tool response", async () => {
    ...
    expect(() =>
      viewer.handleBackendResponse(propertiesResponse),
    ).not.toThrow();
  });
  ...
  test("handleBackendResponse ignores responses without tool_type", async () => {
    ...
    expect(() =>
      viewer.handleBackendResponse(incompleteResponse),
    ).not.toThrow();
  });
});
...
describe("Camera Location Notifications", () => {
  ...
  test("target0 is sent in initial notification", async () => {
    ...
    const target0Notification = collector.notifications.find(
      (n) => "target0" in n,
    );
...
describe("Holroyd Notifications", () => {
  ...
  test("setHolroyd with notify=false does not send notification", async () => {
    ...
    expect(
      getLastNotificationWithKey(collector.notifications, "holroyd"),
    ).toBeNull();
  });
});
...
describe("Notification Timing and Order", () => {
  ...
  test("notifications are sent synchronously", async () => {
    ...
    expect(collector.notifications.length).toBeGreaterThan(0);
    expect(
      getLastNotificationWithKey(collector.notifications, "axes"),
    ).toBeDefined();
  });
  ...
  test("multiple rapid changes preserve order", async () => {
    ...
    const ambientNotifications = collector.notifications.filter(
      (n) => "ambient_intensity" in n,
    );

    // Due to duplicate prevention, we might not get all 3
    // But the final value should be 0.9
    const lastAmbient = getLastNotificationWithKey(
      collector.notifications,
      "ambient_intensity",
    );
  ...
  test("batch updates can be coalesced", async () => {
    ...
    expect(
      getLastNotificationWithKey(collector.notifications, "axes0"),
    ).toBeDefined();
    expect(
      getLastNotificationWithKey(collector.notifications, "ortho"),
    ).toBeDefined();
  });
});
